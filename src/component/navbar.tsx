...
//   { name: 'Home', path: '/home' },
//   {
//     name: 'Visa Service', path: '/service', subPages: [
...
function ResponsiveAppBar() {
  ...
  const handleOpenMobileDropdown = (pageName: string) => {
    setActiveMobileDropdown(activeMobileDropdown === pageName ? null : pageName);
  };
        ...
        <Toolbar disableGutters>
              ...
              page.subPages ? (
                <Box key={page.name}>
                  <Button
                    ...
                    sx={{
                      ...
                      display: 'block',
                      fontWeight: 'bold',
                      fontSize: { md: '14px', lg: '14px', xl: '16px' }, // Increase text size for large devices
                    }}
                    aria-controls={`${page.name}-menu`}
                    aria-haspopup="true"
                  >
                ...
                <Button
                  ...
                  sx={{
                    ...
                    display: 'block',
                    fontWeight: 'bold',
                    fontSize: { md: '14px', lg: '16px', xl: '16px' }, // Increase text size for large devices
                  }}
                >
                  <Link
                    to={page.path}
          ...
          <Box
            ...
            sx={{
              display: { xs: 'none', md: 'flex' },
              ml: 'auto',
              width: { md: 50, lg: 70, xl: 90 },  // Increase size for larger devices
              height: { md: 50, lg: 70, xl: 90 },
            }}
          />
        </Toolbar>
      </Container>
