...
import img from '../../../component/assets/image/ajman.jpg'; // Ensure the path is correct
import Ajamanstep from './ajamanstep1'
import {Ajamansteps} from './ajmanstep2'
const countries = [
        ...
        >
            ...
            >
                ...
                <Typography variant="h5" mt={2} sx={{ fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                    Get 360° Assistance From the UAE's Ajaman Visa Experts
                </Typography>
