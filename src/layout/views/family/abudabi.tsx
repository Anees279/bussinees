...
import img from '../../../component/assets/image/abudhabi.jpg'; // Ensure the path is correct
import Abudabistep from './abudhabistep1'
import {Abudabisteps} from './abudhabistep2'
const countries = [
