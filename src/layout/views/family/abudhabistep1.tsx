...
>
Applying for a family visa in Abu Dhabi
</Typography>

        <Typography variant="body1" align="center" sx={{ maxWidth: "600px" }}>

          Applying for a family visa in Abu Dhabi has never been simpler with
          Business Setup and Documents Clearing. Whether you’re applying for a
          new family visa, renewing an existing one, or considering visa
          cancellations, our expert team is here to guide you through the
          process, ensuring a smooth and hassle-free experience for you and your
          loved ones. Say goodbye to paperwork and uncertainty.
        </Typography>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <CardContent sx={{ textAlign: "center" }}>
              ...
              <Typography variant="body2" color="textSecondary">
                You will be assisted in submitting your application to the
                authorities.
              </Typography>
            </CardContent>
          </Card>
