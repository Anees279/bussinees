...
import Familyvisasteps from './familystep1'
import {Familyvisasteps2} from './familystep2'
import {Familyvisasteps3} from './familystep3'
const countries = [
    ...
    return (
        ...
        >
            ...
            >
                ...
                Family Visa Services in UAE
                </Typography>
                <Typography variant="h5" mt={2} sx={{ fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                A UAE Family Visa allows expatriate residents to sponsor their loved ones for legal residency in the UAE. Designed to reunite families, this visa enables spouses, children, and parents to live, work, and study in the country. 
