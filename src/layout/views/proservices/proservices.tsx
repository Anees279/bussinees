...
import img from '../../../component/assets/image/pro.jpg'; // Ensure the path is correct
import Proone from './proone'
import {Protwo} from './protwo'
import Proplus from './proserviceuae'
import BenefitsOfProServices from "./benifit"
const countries = [
...
Pro Services
                ...
                <Typography variant="h5" mt={2} sx={{ fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                    Get 360° Assistance From the UAE's Pro Visa Experts
                </Typography>
