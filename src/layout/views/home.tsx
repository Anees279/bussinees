...
import slide1 from '../../component/assets/image/pexels-enginakyurt-1435752.jpg';
...
const HereSection: React.FC = () => {
  return (
    <Box className="HereSection" sx={{ width: '100%', height: '90vh', position: 'relative' }}>
      <Swiper
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  animation: 'fadeIn 2s ease-in-out 0.5s forwards, slideIn 1s ease-in-out', // Apply animations
                }}
              >
                <Typography
                  variant="h2"
                ...
                <Typography
                  ...
                  sx={{
                    mt: 2,
                    animation: 'fadeInText 3s ease-in-out 1s forwards, slideInText 1.5s ease-in-out',
