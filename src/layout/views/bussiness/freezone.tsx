...
import img from "../../../component/assets/image/freezone.jpg"; // Ensure the path is correct
import { FreezoneContent } from "./freezonecontent";
import FreezonePLus from "./freezone1"
import { Fre } from "./freezone2";
const countries = [
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Establishing a free zone company in Dubai is an attractive prospect
            for entrepreneurs and investors, offering multiple advantages like
            tax exemptions and lower setup costs. Before making the leap,
            however, it is crucial that one understands all aspects of this
            process before proceeding. Starting a business requires selecting an
            area free from conflict that best aligns with your goals, selecting
            a trade name and gathering all necessary documentation.
          </Typography>
          <Button
            variant="contained"
            color="warning"
