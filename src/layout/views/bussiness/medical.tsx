...
import img from '../../../component/assets/image/med.jpg'; // Ensure the path is correct
import {Medicalcontent} from './medicalcontent'
import {Med} from './medical2'
const countries = [
    ...
    position: 'relative',
        ...
        >
            ...
            >
                ...
                Medical Licencing Service
                </Typography>
                <Typography variant="h5" mt={2} sx={{ fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                Medical Licensing Services for Healthcare Professionals in the UAE
                </Typography>
