...
import img from '../../../component/assets/image/albasara.jpg'; // Ensure the path is correct
import {Albasaracontent} from './albasaracontent'
import {Alb} from './albasara2'
const countries = [
    ...
    position: 'relative',
        ...
        >
            ...
            >
                ...
                Al Barsha Business Setup
                </Typography>
                <Typography variant="h5" mt={2} sx={{ fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                Albasara Licensing Services for Healthcare Professionals in the UAE
                </Typography>
