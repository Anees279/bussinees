...
import img from "../../../component/assets/image/beauty.jpg"; // Ensure the path is correct
import {Beautycontent} from './beautycontent'
import {Beu} from './beauty2'
const countries = [
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            In today’s booming beauty industry, entrepreneurs are realizing the
            potential of opening a beauty salon. The high demand for beauty
            services makes Dubai an ideal location for such a business. With a
            high standard of living and disposable income, people in Dubai
            prioritize personal hygiene and grooming, ensuring that salon
