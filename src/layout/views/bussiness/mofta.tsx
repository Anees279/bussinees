...
import img from "../../../component/assets/image/embassay.jpg"; // Ensure the path is correct
import { Mofacontent } from "./mofacontent";
import { Mof } from "./mofa2";
const countries = [
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            MOFA Attestation is an essential step when traveling abroad with
            documents, ensuring they meet legal requirements in each country
            where they will be used. Processing times and fees depend upon each
            country and type of document submitted for certification.
          </Typography>
