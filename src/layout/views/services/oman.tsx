...
import img from '../../../component/assets/image/oman.jpg'; // Ensure the path is correct
import Omansteps from './omanstep'
import {Omansteps2} from './omanstep2'
const countries = [
